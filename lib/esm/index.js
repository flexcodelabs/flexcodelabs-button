...
var Button = function (_a) {
    ...
    return (React.createElement(React.Fragment, null,
        href && (React.createElement(Link, { href: href },
            React.createElement("a", { style: __assign({ cursor: disabled ? "default" : "pointer", opacity: disabled ? 0.4 : 1, position: "relative" }, style), className: "".concat(className), onClick: function (e) {
                    if (!disabled && ripple) {
                        rippleEffect(e);
                    }
                } }, label))),
