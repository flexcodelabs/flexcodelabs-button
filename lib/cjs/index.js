    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        href && (react_1.default.createElement(Link, { href: href },
            react_1.default.createElement("a", { style: __assign({ cursor: disabled ? "default" : "pointer", opacity: disabled ? 0.4 : 1, position: "relative", display: "inline-flex" }, style), className: "".concat(className), onClick: function (e) {
                ...
                label,
                loading && (react_1.default.createElement(Spinner, { color: spinnerColor, bgColor: spinnerBgColor, size: spinnerSize }))))),
...
var Spinner = function (_a) {
    ...
    return (react_1.default.createElement("span", { className: "spinner", style: __assign({ height: size !== null && size !== void 0 ? size : 15, width: size !== null && size !== void 0 ? size : 15 }, style) }));
};
