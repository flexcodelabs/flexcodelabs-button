...
var Button = function (_a) {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        href && (react_1.default.createElement(Link, { href: href },
            react_1.default.createElement("a", { style: __assign({ cursor: disabled ? "default" : "pointer", opacity: disabled ? 0.4 : 1, position: "relative" }, style), className: "".concat(className), onClick: function (e) {
                    if (!disabled && ripple) {
                        rippleEffect(e);
                    }
                } }, label))),
        to && (react_1.default.createElement(Link, { to: to, className: "".concat(className), onClick: function (e) {
            ...
            }, style: __assign({ cursor: disabled ? "default" : "pointer", opacity: disabled ? 0.4 : 1, position: "relative" }, style) },
        ...
        !Link && (react_1.default.createElement("button", { className: "".concat(className), onClick: function (e) {
            ...
            }, type: type !== null && type !== void 0 ? type : "submit", disabled: disabled !== null && disabled !== void 0 ? disabled : false, style: __assign({ cursor: disabled ? "default" : "pointer", opacity: disabled ? 0.4 : 1, position: "relative" }, style) },
            icon,
            label))));
};
